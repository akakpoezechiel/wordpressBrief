				...
				<div class="cart-product woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr__( 'Remove this item', 'storepress' ),
							esc_attr( $product_id ),
	...
	<div class="cart-footer">
		<div class="cart-ft-totals">
			<div class="cart-ft-amt cart-ft-amt-subtotal ">
				<span class="cart-ft-amt-label"><?php esc_html_e('Subtotal','storepress'); ?></span>
		...
		<div class="cart-ft-buttons-cont">
			<a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="cart-ft-btn button btn btn-primary cart-ft-btn-cart"><?php esc_html_e('View Cart','storepress'); ?></a>
			<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="cart-ft-btn button btn btn-border-secondary cart-ft-btn-checkout"><?php esc_html_e('Checkout','storepress'); ?></a>
		</div>
	</div>
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'storepress' ); ?></p>
