...
class Modern_Ecommerce_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'modern-ecommerce' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $modern_ecommerce_font_awesome_icon_array = modern_ecommerce_font_awesome_icon_array();
                    foreach ($modern_ecommerce_font_awesome_icon_array as $modern_ecommerce_font_awesome_icon) {
                            $icon_class = $this->value() == $modern_ecommerce_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($modern_ecommerce_font_awesome_icon).'"></i>
                            <span class="modern-ecommerce-social-class">'.esc_attr($modern_ecommerce_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function modern_ecommerce_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'modern-ecommerce-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'modern_ecommerce_customizer_script' );

if(!function_exists('modern_ecommerce_font_awesome_icon_array')){
    function modern_ecommerce_font_awesome_icon_array(){
...
"fas fa-message", "far fa-comment-alt",
