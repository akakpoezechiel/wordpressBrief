...
function modern_ecommerce_gettingstarted() {
	add_theme_page( esc_html__('Begin Installation', 'modern-ecommerce'), esc_html__('Begin Installation', 'modern-ecommerce'), 'edit_theme_options', 'modern-ecommerce-guide-page', 'modern_ecommerce_guide');   
}
...
define('MODERN_ECOMMERCE_LIVE_DEMO',__('https://trial.ovationthemes.com/modern-ecommerce-pro/','modern-ecommerce'));
}
if ( ! defined( 'MODERN_ECOMMERCE_BUY_PRO' ) ) {
define('MODERN_ECOMMERCE_BUY_PRO',__('https://www.ovationthemes.com/products/ecommerce-wordpress-theme','modern-ecommerce'));
}
if ( ! defined( 'MODERN_ECOMMERCE_PRO_DOC' ) ) {
define('MODERN_ECOMMERCE_PRO_DOC',__('https://trial.ovationthemes.com/docs/ot-modern-ecommerce-pro-doc/','modern-ecommerce'));
}
if ( ! defined( 'MODERN_ECOMMERCE_FREE_DOC' ) ) {
define('MODERN_ECOMMERCE_FREE_DOC',__('https://trial.ovationthemes.com/docs/ot-modern-ecommerce-free-doc/','modern-ecommerce'));
}
...
function modern_ecommerce_guide() {
	...
	<div class="getting-started__header">
		...
		<div class="col-md-2">
			<div class="btn_box">
				<a class="button-primary" href="<?php echo esc_url( MODERN_ECOMMERCE_FREE_DOC ); ?>" target="_blank"><?php esc_html_e('Theme Documentation', 'modern-ecommerce'); ?></a>
		...
		<div class="container">
			<div class="col-md-9">
				<div class="leftbox">
					...
					<p><?php esc_html_e('Go to dashboard >> Products >> Add New products >> Add title, content >> Assign category >> Publish it.','modern-ecommerce'); ?></p>
		
					<p><?php esc_html_e('Go to dashboard >> Appearance >> Customize >> Product Settings >> Select Categorey.','modern-ecommerce'); ?></p>
