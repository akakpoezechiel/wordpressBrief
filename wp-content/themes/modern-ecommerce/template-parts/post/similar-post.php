...
$modern_ecommerce_post_args = array(
    'posts_per_page'    => '3',
    'orderby'           => 'rand',
...
$modern_ecommerce_ids = array();
foreach( $related as $term ) {
    $modern_ecommerce_ids[] = $term->term_id;
}

$modern_ecommerce_post_args['category__in'] = $modern_ecommerce_ids; 

$related_posts = new WP_Query( $modern_ecommerce_post_args );

if ( $related_posts->have_posts() ) : ?>
    <div id="Category-section" class="similar-post">
        <h3 class="text-center pb-3"><?php echo esc_html(get_theme_mod('modern_ecommerce_similar_text',__('Explore More','modern-ecommerce'))); ?></h3>
        <div class="row">
