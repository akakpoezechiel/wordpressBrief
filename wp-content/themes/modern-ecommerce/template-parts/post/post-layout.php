...
?>
<?php
$modern_ecommerce_post_option = get_theme_mod( 'modern_ecommerce_post_option','right_sidebar');
if($modern_ecommerce_post_option == 'right_sidebar'){ ?>
...
<?php }
else if($modern_ecommerce_post_option == 'left_sidebar'){ ?>
<div id="sidebar" class="col-lg-4 col-md-4"><?php get_sidebar(); ?></div>
<div class="content_area col-lg-8 col-md-8">
    <section id="post_section">
        <div class="row">
...
<?php } 
else if($modern_ecommerce_post_option == 'one_column'){ ?>
...
<?php }
else if($modern_ecommerce_post_option == 'three_column'){ ?>
...
<?php }
else if($modern_ecommerce_post_option == 'four_column'){ ?>
<div id="sidebar" class="col-lg-3 col-md-3 custom-sidebar-class"><?php dynamic_sidebar('sidebar-3'); ?></div>
...
<div id="sidebar" class="col-lg-3 col-md-3 custom-sidebar-class"><?php get_sidebar(); ?></div>
<?php }
else if($modern_ecommerce_post_option == 'grid_sidebar'){ ?>
<div class="content_area col-lg-8 col-md-8">
    <section id="post_section">
        <div class="row">
            <?php
...
<div id="sidebar" class="col-lg-4 col-md-4"><?php get_sidebar(); ?></div>
<?php }
else if($modern_ecommerce_post_option == 'grid_left_sidebar'){ ?>
<div id="sidebar" class="col-lg-4 col-md-4"><?php get_sidebar(); ?></div>
<div class="content_area col-lg-8 col-md-8">
    <section id="post_section">
        <div class="row">
