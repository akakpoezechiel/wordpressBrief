	...
	<header class="page-header">
		...
		<?php else : ?>
			...
			<div class="internal-div">
				...
				<?php } ?>
				<h2 class="page-title mt-4 text-center"><span><?php esc_html_e( 'Nothing Found', 'modern-ecommerce' ); ?></span></h2>
			</div>
		<?php endif; ?>
	</header>
	<?php }
		...
		<header class="mt-4">
			...
			<?php else : ?>
				...
				<?php } ?>
				<h2 class="page-title mt-4 withoutimg text-center"><span><?php esc_html_e( 'Nothing Found', 'modern-ecommerce' ); ?></span></h2>
			<?php endif; ?>
		</header>
	<?php } ?>
	<div class="container">
